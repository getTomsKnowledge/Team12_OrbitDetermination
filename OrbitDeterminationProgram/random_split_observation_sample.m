...
function [begSample, midSample, endSample] = random_split_observation_sample(total, N, split)
    ...
    groupSum = g1Count + g2Count + g3Count;
    fprintf('Sum of observations:  %d', groupSum);
